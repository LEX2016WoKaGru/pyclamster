...
session = pyclamster.CameraSession(
    images="/home/yann/Studium/LEX/LEX/cam/cam4/calibration/north/FE4*.jpg",
...
for image in session: # loop over all images
    # get time
    imgtime = image._get_time_from_filename(fmt="FE4_Image_%Y%m%d_%H%M%S_UTCp1.jpg")
...
pickle.dump(sun_img,open("data/fe4/FE4_straightcalib_sun_img.pk","wb"))
...
pickle.dump(sun_real,open("data/fe4/FE4_straightcalib_sun_real.pk","wb"))
