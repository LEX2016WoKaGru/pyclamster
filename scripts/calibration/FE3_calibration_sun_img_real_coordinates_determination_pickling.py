...
session = pyclamster.CameraSession(
    images="/home/yann/Studium/LEX/LEX/cam/cam3/calibration/north1/FE3*.jpg",
...
#pickle.dump(sun_img,open("data/FE3_straightcalib_sun_img.pk","wb"))
...
pickle.dump(sun_real,open("data/FE3_straightcalib_sun_real.pk","wb"))
