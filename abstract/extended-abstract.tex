...
\linespread{1.09} % Zeilenabstand definieren
...
mit den Ceilometer-Wolkenbasishöhen vergleichbar sind.\footnotetext{Map data
copyrighted OpenStreetMap contributors and available from
\url{http://www.openstreetmap.org}}\absatz Es wird davon ausgegangen, dass
