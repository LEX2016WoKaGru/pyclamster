...
\usepackage{ifthen}     % Damit an if-else-Strukturen machen kann
...
\newcommand{\lb}{\smallbreak} % Standardmäßig \lb zur Trennung von Absätzen verwendet und hier das Kommando anpassen
